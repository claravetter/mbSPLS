...
vars = {'name', 'Xs', 'Xs_names', 'Xs_feature_names', 'type_correction', 'covariates', 'covariates_names', ...
    'DiagNames', 'framework', 'outer_folds', 'inner_folds', ...
    'permutation_testing', 'bootstrap_testing', 'correlation_method', ...
    'optimization_strategy', 'mult_test', 'statistical_testing'};
