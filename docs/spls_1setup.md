...
| `covariate_names`          | Cell array (string)      | If you would like to correct for covariates, define the name(s) of your covariate(s) (e.g., `input.covariate_names = {'PC1'}, {'PC2'}, {'PC3'}`, `input.covariate_names = {'Site1'}, {'Site2'}, {'Site3'}`). The length of `input.covariate_names`should equal the number of columns in `input.covariates`. |
